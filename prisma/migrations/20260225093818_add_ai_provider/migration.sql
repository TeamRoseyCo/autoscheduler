...
INSERT INTO "new_Preferences" ("breakMinutes", "deepWorkEnd", "deepWorkStart", "id", "openaiApiKey", "openaiModel", "timezone", "userId", "workDays", "workEndTime", "workStartTime") SELECT "breakMinutes", "deepWorkEnd", "deepWorkStart", "id", "openaiApiKey", "openaiModel", "timezone", "userId", "workDays", "workEndTime", "workStartTime" FROM "Preferences";
